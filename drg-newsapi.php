<?php
/**
 * Plugin Name: DRG NewsAPI Plugin
 * Description: Fetches data from NewsAPI.org API and displays news.
 * Version: 1.0
 * Author: Angel Vera
 */
...
function newsapi_fetch_news() {
  ...
  $endpoint = 'https://newsapi.org/v2/top-headlines?country=mx&apiKey=4e3468a37d2b4c88aa3468fb143a7934';
